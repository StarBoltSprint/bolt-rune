...
export function inlinedSeatEnv(): Record<string, string | undefined> {
  return {
    ...
    COOK_WAKE_URL: process.env.COOK_WAKE_URL,
    CONTINUITY_WAKE_URL: process.env.CONTINUITY_WAKE_URL,
    DOOR_BOT_ID: process.env.DOOR_BOT_ID,
    SMOKE_BOT_ID: process.env.SMOKE_BOT_ID,
    COOK_BOT_ID: process.env.COOK_BOT_ID,
    CONTINUITY_BOT_ID: process.env.CONTINUITY_BOT_ID,
    ...
    GROK_COOK_WAKE_URL: process.env.GROK_COOK_WAKE_URL,
    GROK_CONTINUITY_WAKE_URL: process.env.GROK_CONTINUITY_WAKE_URL,
